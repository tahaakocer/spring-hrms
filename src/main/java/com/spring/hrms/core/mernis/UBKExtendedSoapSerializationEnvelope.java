...
class UBKSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class UBKExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(UBKDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new UBKStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static UBKDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static UBKDateTimeConverter dateTimeConverter = new UBKStandardDateTimeConverter();

    public UBKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public UBKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new UBKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=UBKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,UBKExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=UBKHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
