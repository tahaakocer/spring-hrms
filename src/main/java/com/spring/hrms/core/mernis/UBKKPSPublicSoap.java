...
public class UBKKPSPublicSoap
{
    ...
    public UBKKPSPublicSoap(){}

    public UBKKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public UBKKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        UBKExtendedSoapSerializationEnvelope envelope= new UBKExtendedSoapSerializationEnvelope(UBKExtendedSoapSerializationEnvelope.VER11);
